                            ...
                            if ($stmt_insert_attendance->execute()) {
                                ...
                                if ($stmt_insert_attendance_record) {
                                    ...
                                    if ($stmt_insert_attendance_record->execute()) {
                                        $conn->commit();
                                        $success_message = "New student registered and attendance record updated successfully!";
                                    } else {
                                        $conn->rollback();
                                        $error_message = "Error inserting into attendance_record: " . $stmt_insert_attendance_record->error;
                                    }
                                    $stmt_insert_attendance_record->close();
                                } else {
                                    $conn->rollback();
